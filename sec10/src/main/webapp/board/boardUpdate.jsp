			...
			<table>
				<tr>
					...
					<td><input type="text" size="12" name="name"
						value="${board.name }" required="required"> * 필수</td>
				</tr>
				<tr>
					<th>비밀번호</th>
					<td><input type="password" size="20" name="pass"
						required="required"> * 필수 (게시물 수정 삭제시 필요합니다.)</td>
				</tr>
				<tr>
					<th>이메일</th>
				...
				<tr>
					<th>내용</th>
					<td><textarea name="content" rows="15" cols="70"  required="required">${board.content }</textarea></td>
				</tr>
			</table>
			<br><br><hr>
